/*
    ...
    Name: Jsh // Lab7 and Lab 8
    Author: Jacob Page
    A simple version of a shell that can execute commands and implements the use of <, >, >>, and |
...
/**
* @name DupManager.
* @brief Opens the correct file descriptor depending on if the command has a <, >, or >>.
* @param[in] mode the mode is 1 for >, 2 for <, and 3 for >>.
* @param[in] fileName the name of the file that needs to be opened .
* @return Nothing.
*/
